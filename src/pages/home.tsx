      ...
      <section className="bg-gray-50">
        <div className="mx-auto max-w-md sm:max-w-md md:max-w-full">
          ...
          <div className="flex w-full flex-col items-center gap-5 md:flex-row">
            <p className="flex">📩 Write heartfelt messages</p>
            <p className="flex">📆 Pick the date of the message</p>
            <p className="flex">📸 Upload captivating photos</p>
            <p className="flex">🎤 Record unforgettable sound bites</p>
            <p className="flex">✊ Rest we will handle for you</p>
          </div>
